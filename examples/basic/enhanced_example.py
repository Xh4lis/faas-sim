...
def run_simulation():
    ...
    benchmark = ConstantBenchmark(['python-pi', 'resnet50-inference'], 
                                duration=2, rps=5)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run faas-sim basic example with analysis')
    parser.add_argument('--dashboard', action='store_true', help='Launch dashboard after simulation')
