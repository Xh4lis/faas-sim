...
ai_execution_time_distributions = {
    ("rpi3", "faas-workloads/python-pi"): (
        1.909987211227417,
        2.203219413757324,
        PDist.lognorm(((1.5561351906586467,), 1.9092154433285176, 0.03832589013392289)),
    ),
    ...
    ("rockpi", "faas-workloads/python-pi"): (
        0.9023468494415283,
        0.96213698387146,
        PDist.lognorm(
    ...
    ("coral", "faas-workloads/python-pi"): (
        1.6157212257385254,
        1.6432366371154785,
        PDist.lognorm(
    ...
    ("xeongpu", "faas-workloads/fio"): (
        1.1168184280395508,
        1.1966462135314941,
        PDist.lognorm(((0.547478970870047,), 1.1083822085143797, 0.030433853662662387)),
    ),
    ("xeoncpu", "faas-workloads/fio"): (
        1.1168184280395508,
        1.1966462135314941,
        PDist.lognorm(((0.547478970870047,), 1.1083822085143797, 0.030433853662662387)),
    ),
    ("tx2", "faas-workloads/fio"): (
        4.199761152267456,
        4.508903503417969,
        PDist.lognorm(((1.3756415929126355,), 4.198414125199262, 0.05290299893253018)),
    ),
    ("nano", "faas-workloads/fio"): (
        17.634405612945557,
        21.379503965377808,
        PDist.lognorm(
            ((0.018126581624838864,), -20.429942918329502, 40.06238600923392)
        ),
    ),
    ("nx", "faas-workloads/fio"): (
        13.390366792678833,
        14.499114036560059,
        PDist.lognorm(((1.2593738429645396,), 13.379751217809101, 0.21565860828690103)),
    ),
    ("rpi4", "faas-workloads/fio"): (
        23.43714690208435,
        33.209991216659546,
        PDist.lognorm(
            ((0.009384653682239431,), -156.36010377296788, 184.15597782535895)
        ),
    ),
    ("nuc", "faas-workloads/fio"): (
        1.0893218517303467,
        1.3713059425354004,
        PDist.lognorm(((1.1299582738854954,), 1.088922789515207, 0.014824511843598303)),
    ),
    ("rockpi", "faas-workloads/fio"): (
        21.46393871307373,
        23.428807735443115,
        PDist.lognorm(((0.6243415046474259,), 21.333338896210595, 0.544673148530165)),
    ),
    ("rpi3", "faas-workloads/fio"): (
        23.947848558425903,
        41.15871047973633,
        PDist.lognorm(((1.4725990652984735,), 23.901942788072812, 2.061301749245649)),
    ),
    ("tx2", "faas-workloads/resnet-inference-cpu"): (
        0.6948370933532715,
        1.1444413661956787,
        PDist.lognorm(((0.8501001928589622,), 0.6917307756410416, 0.03637932277634568)),
    ),
    ("nano", "faas-workloads/resnet-inference-cpu"): (
        0.8841347694396973,
        1.3210082054138184,
        PDist.lognorm(
    ...
    ("nx", "faas-workloads/resnet-inference-cpu"): (
        0.4536397457122803,
        0.5972743034362793,
        PDist.lognorm(
    ...
    ("rockpi", "faas-workloads/resnet-inference-cpu"): (
        1.1331660747528076,
        1.9165077209472656,
        PDist.lognorm(((0.1701387081476361,), 0.6767214411001377, 0.6915067219689892)),
    ),
    ("coral", "faas-workloads/resnet-inference-cpu"): (
        1.4113075733184814,
        3.642624855041504,
        PDist.lognorm(((0.5091677176621551,), 1.1979548997737532, 0.8673575947926709)),
    ),
    ...
    ("xeoncpu", "faas-workloads/resnet-inference-cpu"): (
        0.1462233066558838,
        0.3092348575592041,
        PDist.lognorm(
            ((1.250516246833203,), 0.14569116166838314, 0.015314005461484962)
    ...
    ("nuc", "faas-workloads/resnet-inference-cpu"): (
        0.1407608985900879,
        0.30925583839416504,
        PDist.lognorm(
    ...
    ("tx2", "faas-workloads/resnet-inference-gpu"): (
        0.37734198570251465,
        0.8128652572631836,
        PDist.lognorm(
    ...
    ("nano", "faas-workloads/resnet-inference-gpu"): (
        0.6658952236175537,
        1.843451738357544,
        PDist.lognorm(((0.9361873291014332,), 0.6630484909941858, 0.04025457729806213)),
    ),
    ("nx", "faas-workloads/resnet-inference-gpu"): (
        0.36667823791503906,
        0.7085371017456055,
        PDist.lognorm(
    ...
    ("xeongpu", "faas-workloads/resnet-inference-gpu"): (
        0.11229228973388672,
        0.3232553005218506,
        PDist.lognorm(
    ...
    ("tx2", "faas-workloads/speech-inference-gpu"): (
        3.1765449047088623,
        3.380650758743286,
        PDist.lognorm(
    ...
    ("nano", "faas-workloads/speech-inference-gpu"): (
        4.365040063858032,
        4.694480657577515,
        PDist.lognorm(
    ...
    ("nx", "faas-workloads/speech-inference-gpu"): (
        1.5870838165283203,
        1.835263967514038,
        PDist.lognorm(((0.3409027343356294,), 1.5597613802886927, 0.08327712822735661)),
    ),
    ("xeongpu", "faas-workloads/speech-inference-gpu"): (
        0.71323561668396,
        0.7919847965240479,
        PDist.lognorm(((0.008946086677742587,), -1.307494985069547, 2.055274866615258)),
    ),
    ("tx2", "faas-workloads/speech-inference-tflite"): (
        3.3613061904907227,
        3.548738956451416,
        PDist.lognorm(((0.14837049015268372,), 3.1825127376318507, 0.2542879539682151)),
    ),
    ("nano", "faas-workloads/speech-inference-tflite"): (
        3.811147451400757,
        4.026976585388184,
        PDist.lognorm(((0.338573110489491,), 3.756233885601591, 0.12222610657663688)),
    ),
    ("nx", "faas-workloads/speech-inference-tflite"): (
        2.511276960372925,
        2.8111839294433594,
        PDist.lognorm(
    ...
    ("rpi3", "faas-workloads/speech-inference-tflite"): (
        15.982834100723267,
        17.307713270187378,
        PDist.lognorm(((0.2990468329948087,), 15.530564025376192, 0.9842449631740879)),
    ),
    ("rpi4", "faas-workloads/speech-inference-tflite"): (
        6.625596523284912,
        6.853733539581299,
        PDist.lognorm(
    ...
    ("rockpi", "faas-workloads/speech-inference-tflite"): (
        3.65761399269104,
        3.972121000289917,
        PDist.lognorm(
    ...
    ("xeongpu", "faas-workloads/speech-inference-tflite"): (
        1.0549635887145996,
        1.1173889636993408,
        PDist.lognorm(((0.3862192323604978,), 1.040493169321096, 0.03485261244686297)),
    ),
    ("xeoncpu", "faas-workloads/speech-inference-tflite"): (
        1.0549635887145996,
        1.1173889636993408,
        PDist.lognorm(((0.3862192323604978,), 1.040493169321096, 0.03485261244686297)),
    ),
    ...
    ("nuc", "faas-workloads/speech-inference-tflite"): (
        1.0520174503326416,
        1.086385726928711,
        PDist.lognorm(
    ...
    ("tx2", "faas-workloads/mobilenet-inference-tflite"): (
        0.3218262195587158,
        0.3404886722564697,
        PDist.lognorm(
    ...
    ("nano", "faas-workloads/mobilenet-inference-tflite"): (
        0.4417688846588135,
        0.45539116859436035,
        PDist.lognorm(((2.23565414673075,), 0.44176341795738083, 0.002910299253376422)),
    ),
    ("nx", "faas-workloads/mobilenet-inference-tflite"): (
        0.3183910846710205,
        0.35461950302124023,
        PDist.lognorm(
    ...
    ("rpi4", "faas-workloads/mobilenet-inference-tflite"): (
        1.2563717365264893,
        1.3392689228057861,
        PDist.lognorm(((0.492750480136671,), 1.2433487914150247, 0.03528135900856)),
    ),
    ("rockpi", "faas-workloads/mobilenet-inference-tflite"): (
        0.37113523483276367,
        0.6942205429077148,
        PDist.lognorm(((0.15694893846245875,), 0.09924997518597733, 0.411072865085738)),
    ),
    ("coral", "faas-workloads/mobilenet-inference-tflite"): (
        0.6539947986602783,
        0.7023055553436279,
        PDist.lognorm(
    ...
    ("xeongpu", "faas-workloads/mobilenet-inference-tflite"): (
        0.26646852493286133,
        0.3171541690826416,
        PDist.lognorm(
    ...
    ("xeoncpu", "faas-workloads/mobilenet-inference-tflite"): (
        0.26646852493286133,
        0.3171541690826416,
        PDist.lognorm(
            ((0.5365853735187458,), 0.2629530210923786, 0.017526290870830248)
    ...
    ("nuc", "faas-workloads/mobilenet-inference-tflite"): (
        0.2647244930267334,
        0.308530330657959,
        PDist.lognorm(((0.213495159031093,), 0.24391558677812142, 0.03560607539324892)),
    ),
    ("coral", "faas-workloads/mobilenet-inference-tpu"): (
        0.531743049621582,
        0.5755233764648438,
        PDist.lognorm(((0.23466525119207204,), 0.5059029828658818, 0.0405198874588389)),
    ),
    ("tx2", "faas-workloads/resnet-preprocessing"): (
        6.223581314086914,
        6.590674638748169,
        PDist.lognorm(((0.25278510391411824,), 6.076221026439702, 0.30137273301561684)),
    ),
    ("nano", "faas-workloads/resnet-preprocessing"): (
        7.8491973876953125,
        9.16739535331726,
        PDist.lognorm(((0.749277313721395,), 7.838747661086966, 0.07855304435000107)),
    ),
    ("nx", "faas-workloads/resnet-preprocessing"): (
        5.809688329696655,
        6.8749473094940186,
        PDist.lognorm(((0.2463529274947488,), 5.5980717469353, 0.46803545566088733)),
    ),
    ...
    ("rpi4", "faas-workloads/resnet-preprocessing"): (
        18.986950397491455,
        20.01262331008911,
        PDist.lognorm(
    ...
    ("rockpi", "faas-workloads/resnet-preprocessing"): (
        7.352227449417114,
        8.141456127166748,
        PDist.lognorm(((0.1897235590296447,), 6.987563394961493, 0.6473314423433307)),
    ),
    ("coral", "faas-workloads/resnet-preprocessing"): (
        10.412590026855469,
        10.664041996002197,
        PDist.lognorm(
    ...
    ("nuc", "faas-workloads/resnet-preprocessing"): (
        2.467944383621216,
        2.5904436111450195,
        PDist.lognorm(
    ...
    ("xeongpu", "faas-workloads/resnet-preprocessing"): (
        2.5816872119903564,
        2.73801851272583,
        PDist.lognorm(
    ...
    ("xeoncpu", "faas-workloads/resnet-preprocessing"): (
        2.5816872119903564,
        2.73801851272583,
        PDist.lognorm(
            ((0.0046462923279184595,), -3.733773151864244, 6.398168798011675)
    ...
    ("nx", "faas-workloads/resnet-training-gpu"): (
        139.35805344581604,
        144.51621437072754,
        PDist.lognorm(
    ...
    ("tx2", "faas-workloads/resnet-training-gpu"): (
        225.4308431148529,
        234.05239510536194,
        PDist.lognorm(((0.6361116541813518,), 224.70438940974208, 2.810213847353603)),
    ),
    ...
    ("nuc", "faas-workloads/resnet-training-cpu"): (
        196.37506127357483,
        202.84338760375977,
        PDist.lognorm(((0.4738306908521043,), 196.1424565418967, 1.153017771389426)),
    ),
    ("nx", "faas-workloads/tf-gpu"): (
        1.158355951309204,
        1.208902359008789,
        PDist.lognorm(
            ((0.6352649591792237,), 1.1545879504235148, 0.015347490963527024)
        ),
    ),
    ("xeongpu", "faas-workloads/tf-gpu"): (
        0.36005401611328125,
        0.37538766860961914,
        PDist.lognorm(
...
ai_min_max_execution_times = {
    "faas-workloads/tf-gpu": (0.36531192779541016, 1.8881448245048522),
...
ai_mean_execution_times = {
    "faas-workloads/tf-gpu": {
        "nx": 1.1731165671348571,
        "nano": 0.6205120253562927,
        "xeongpu": 0.36531192779541016,
        "tx2": 1.8881448245048522,
    },
    "faas-workloads/speech-inference-gpu": {
        "nx": 1.6482071661949158,
        "nano": 4.544314980506897,
        "xeongpu": 0.747898964881897,
        "tx2": 3.3071153211593627,
    },
    "faas-workloads/resnet-training-gpu": {
        "nx": 141.99886816077762,
        "nano": 847.171815255109,
        "xeongpu": 32.12711091739376,
        "tx2": 228.1172546479437,
    },
    "faas-workloads/speech-inference-tflite": {
        "nx": 2.6837231802940367,
        "nano": 3.8856320667266844,
        "xeoncpu": 1.0779976797103883,
        "xeongpu": 1.0779976797103883,
        "tx2": 3.4396099495887755,
        "rpi3": 16.559413411617278,
        "rpi4": 6.7493284320831295,
        "nuc": 1.0626225304603576,
        "coral": 7.2140442943573,
        "rockpi": 3.815823349952698,
    },
    "faas-workloads/resnet-preprocessing": {
        "nx": 6.081014342308045,
        "nano": 7.95175134897232,
        "xeoncpu": 2.6644398760795593,
        "xeongpu": 2.6644398760795593,
        "tx2": 6.387359216213226,
        "rpi3": 30.478582429331404,
        "rpi4": 19.502971405982972,
        "nuc": 2.5259750509262084,
        "coral": 10.51350971698761,
        "rockpi": 7.646788821220398,
    },
    "faas-workloads/mobilenet-inference-tflite": {
        "nx": 0.33246784210205077,
        "nano": 0.4461205530166626,
        "xeoncpu": 0.2831557750701904,
        "xeongpu": 0.2831557750701904,
        "tx2": 0.3282004809379578,
        "rpi3": 2.0728497886657715,
        "rpi4": 1.2829871106147765,
        "nuc": 0.2803403902053833,
        "coral": 0.6648596024513245,
        "rockpi": 0.5154055190086365,
    },
    "faas-workloads/python-pi": {
        "nx": 0.8302664136886597,
        "nano": 0.7489693427085876,
        "xeoncpu": 71.5935873889923,
        "xeongpu": 71.5935873889923,
        "tx2": 0.5480701279640198,
        "rpi3": 25.670029578208922,
        "rpi4": 23.58836589574814,
        "nuc": 0.24590346574783326,
        "coral": 1.8222162294387818,
        "rockpi": 0.9157870554924011,
    },
    "faas-workloads/fio": {
        "nx": 13.771749126911164,
        "nano": 19.639060771465303,
        "xeoncpu": 1.143465440273285,
        "xeongpu": 1.143465440273285,
        "tx2": 4.314488160610199,
        "rpi3": 28.66214724727299,
        "rpi4": 27.808915467262267,
        "nuc": 1.1227234315872192,
        "rockpi": 21.987778232097625,
    },
    "faas-workloads/resnet-inference-cpu": {
        "nx": 0.5094686794281006,
        "nano": 0.9278767776489257,
        "xeoncpu": 0.1696533441543579,
        "xeongpu": 0.1696533441543579,
        "tx2": 0.7448488783836364,
        "rpi3": 5.095058534145355,
        "rpi4": 2.9077649402618406,
        "nuc": 0.15748303413391113,
        "coral": 2.1848344469070433,
        "rockpi": 1.3783342552185058,
    },
    "faas-workloads/resnet-training-cpu": {"nuc": 197.44802653944336},
    "faas-workloads/resnet-inference-gpu": {
        "nx": 0.38789546728134155,
        "nano": 0.7286638289081807,
        "xeongpu": 0.12844885587692262,
