def calculate_energy(device_type, cpu_util, disk_io_kb_s, gpu_util, memory_kb, network_mb_s, duration_s):
    """
    ...
    total_power = power_base + power_cpu + power_gpu + power_memory + power_disk + power_network
